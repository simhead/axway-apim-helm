...
{{/*
ANM name
SAMPLE to use full name: {{- default .Chart.Name .Values.anm.nameOverride | trunc 63 | trimSuffix "-" -}}-anm
*/}}
{{- define "anm.name" -}}
...
SAMPLE to use full name: {{- default .Chart.Name .Values.apiportal.nameOverride | trunc 63 | trimSuffix "-" -}}-apiportal
*/}}
...
{{- if .Values.analytics.nameOverride -}}
{{ .Values.analytics.nameOverride }}
{{- else -}}
{{- "analytics" -}}
{{- end -}}
{{- end -}}
